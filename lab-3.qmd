...
plot_ly(data = percent_effective_and_science, 
  ...
  layout(plot_bgcolor='white',
    ...
    yaxis = list(range = list(0, 1), tickformat = ".0%",
                 title = ""), 
    title = 
      "Belief in Effectiveness Vaccines Versus Claimed Knowledge of Science",
...
::: {.card title="Percentage of Population Who Have Trust In Scientists"}
